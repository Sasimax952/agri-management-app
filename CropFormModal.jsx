...
const CropFormModal = ({ isOpen, onClose, onSubmit, currentCrop, seasons, fertilizers }) => {
  ...
  }, [currentCrop, seasons, fertilizers]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!formData.name || !formData.yield || !formData.area) return;
    onSubmit(formData);
  };
